...
dataset4 = video4[,c("europe_views_percentage")]
# dataset:
data=data.frame(type=c( rep("variable 1", 13), rep("variable 2", 13), rep("variable 3", 13), rep("variable 4", 13) ),value=c(dataset1,dataset2,dataset3,dataset4))
